...
Anova confirms here that the group differences we were able to see in the plots were real. P-values were significant  and this means there is significant difference in  mean weights between groups. There was also significant difference in group 2 procentual growth as judged by the plottings
```{r}
library(dplyr)
library(tidyr)
...
```
By visual judgning there seems to be a modest downward trend in BPRS for both treatments during the study. 

...
# Create a  smaller dataset with  interesting variables
teaS <- select(tea_, one_of(c("How", "how", "where", "friends", "breakfast", "dinner", "evening", "Tea", "sugar")))


# Plot
pivot_longer(teaS, cols = everything()) %>% 
